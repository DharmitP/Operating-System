...
struct trapframe {
	...
	u_int32_t tf_v0;	/* Saved register 2 (v0)  error value or return value*/
	u_int32_t tf_v1;	/* etc. */
	u_int32_t tf_a0;
	u_int32_t tf_a1;
	u_int32_t tf_a2;
	u_int32_t tf_a3;        /*error or no error (1 or 0)*/
	u_int32_t tf_t0;
	u_int32_t tf_t1;
	u_int32_t tf_t2;
	u_int32_t tf_t3;
...
void md_forkentry(struct trapframe *tf, struct addrspace *child_as);
