...
struct lock {
	...
	void* threadAddr; // store address of the thread that acquired it. (point to same memory location)
	volatile int isLocked; // simple variable to check if locked by anything or not
};
